...
nock('https://devapi.currencycloud.com:443')
  ...
  .reply(200, {"auth_token": "04e61732784d6d6c4a4c7d25a8a74284"});
...
nock('https://devapi.currencycloud.com:443')
  ...
  .reply(200, {
    "login_id": "john.1",
    "id": "9e27cd81-2556-4746-866a-781a4f904387",
    "first_name": "John",
    "last_name": "Smith",
    "account_id": "78618e58-da3c-447f-ad59-1796accfeff9",
    "account_name": "Currencycloud",
    ...
    "your_reference": "ACME12345",
    "date_of_birth": "1980-01-22",
    "created_at": "2017-10-21T23:18:11+00:00",
    "updated_at": "2017-10-21T23:18:11+00:00"
  });
...
nock('https://devapi.currencycloud.com:443')
  .post('/v2/beneficiaries/create', {
    ...
    "on_behalf_of": "9e27cd81-2556-4746-866a-781a4f904387"
  })
  .reply(200, {
    "id": "91a31f30-6380-442f-8747-e4b5f909dad9",
    "bank_account_holder_name": "John Doe",
    "name": "Employee Funds",
    "email": null,
    ...
    "iban": "DE75512108001245126199",
    "default_beneficiary": "true",
    "creator_contact_id": "9e27cd81-2556-4746-866a-781a4f904387",
    "bank_address": ["KAISERSTRASSE 16", "60261 FRANKFURT AM MAIN"],
    "created_at": "2017-10-21T23:18:12+00:00",
    "updated_at": "2017-10-21T23:18:12+00:00"
  });
...
nock('https://devapi.currencycloud.com:443')
  ...
  .reply(200, {
    ...
    "your_reference": "ACME12345",
    "date_of_birth": "1980-01-22",
    "created_at": "2017-10-21T23:18:13+00:00",
    "updated_at": "2017-10-21T23:18:13+00:00"
  });
...
nock('https://devapi.currencycloud.com:443')
  .post('/v2/beneficiaries/create', {
    ...
    "beneficiary_date_of_birth": "1990-07-20",
    "beneficiary_identification_type": "none",
    "on_behalf_of": "12d4f6d3-7a52-47e1-8e35-6017a492e3e3"
  })
  .reply(200, {
    ...
    "bank_address": ["KAISERSTRASSE 16", "60261 FRANKFURT AM MAIN"],
    "created_at": "2017-10-21T23:18:14+00:00",
    "updated_at": "2017-10-21T23:18:14+00:00"
  });
...
nock('https://devapi.currencycloud.com:443')
  ...
  .reply(200, {
    ...
    "locale": "en",
    "timezone": "Europe/London",
    "email_address": "development@currencycloud.com",
    "mobile_phone_number": null,
    "phone_number": null,
    "your_reference": null,
    "date_of_birth": null,
    "created_at": "2017-10-13T11:47:30+00:00",
    "updated_at": "2017-10-13T11:47:30+00:00"
  });
...
nock('https://devapi.currencycloud.com:443')
  ...
  .reply(200, {
    ...
    "bank_address": ["KAISERSTRASSE 16", "60261 FRANKFURT AM MAIN"],
    "created_at": "2017-10-21T23:18:15+00:00",
    "updated_at": "2017-10-21T23:18:15+00:00"
  });
